            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if (!isAnchored) {
                        ...
                        Log.d(TAG, "oldPositionY:" + oldPositionY);
                        ...
                        Log.d(TAG, "currentPositionY: " + currentPositionY);
    ...
    private void setDefaultImage(View v) {
        if (v != null && v.getBackground() == null) {
            ...
            /*if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                v.setBackground(getResources().getDrawable(R.mipmap.menu));
            } else {
                v.setBackgroundDrawable(context.getResources().getDrawable(R.mipmap.menu));
            }
