...
public class Itemdetail__ {
    ...
    public Itemdetail__ withMyitem(Integer myitem) {
        this.myitem = myitem;
        return this;
    }
    ...
    public Itemdetail__ withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public Itemdetail__ withItemQty(Integer itemQty) {
        this.itemQty = itemQty;
        return this;
    }
    ...
    public Itemdetail__ withItemQtyRemained(Integer itemQtyRemained) {
        this.itemQtyRemained = itemQtyRemained;
        return this;
    }
    ...
    public Itemdetail__ withIspurchased(Integer ispurchased) {
        this.ispurchased = ispurchased;
        return this;
    }
    ...
    public Itemdetail__ withItemName(String itemName) {
        this.itemName = itemName;
        return this;
    }
    ...
    public Itemdetail__ withMediaType(String mediaType) {
        this.mediaType = mediaType;
        return this;
    }
    ...
    public Itemdetail__ withMediaUrl(String mediaUrl) {
        this.mediaUrl = mediaUrl;
        return this;
    }
    ...
    public Itemdetail__ withMediaThumb(String mediaThumb) {
        this.mediaThumb = mediaThumb;
        return this;
    }
    ...
    public Itemdetail__ withItemActualprice(String itemActualprice) {
        this.itemActualprice = itemActualprice;
        return this;
    }
    ...
    public Itemdetail__ withItemShippingCost(String itemShippingCost) {
        this.itemShippingCost = itemShippingCost;
        return this;
    }
    ...
    public Itemdetail__ withItemCreatedBy(String itemCreatedBy) {
        this.itemCreatedBy = itemCreatedBy;
        return this;
    }
    ...
    public Itemdetail__ withItemPrice(Integer itemPrice) {
        this.itemPrice = itemPrice;
        return this;
    }
    ...
    public Itemdetail__ withIspaypal(Integer ispaypal) {
        this.ispaypal = ispaypal;
        return this;
    }
    ...
    public Itemdetail__ withIsbitcoin(Integer isbitcoin) {
        this.isbitcoin = isbitcoin;
        return this;
    }
    ...
    public Itemdetail__ withBitcoinmail(String bitcoinmail) {
        this.bitcoinmail = bitcoinmail;
        return this;
    }
    ...
    public Itemdetail__ withUsername(String username) {
        this.username = username;
        return this;
    }
