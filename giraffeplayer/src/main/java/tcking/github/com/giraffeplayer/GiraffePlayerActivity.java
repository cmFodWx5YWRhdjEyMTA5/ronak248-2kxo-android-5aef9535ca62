...
public class GiraffePlayerActivity extends Activity {
    ...
    private static final String TAG = "GiraffePlayerActivity";
    public static GiraffePlayer.GiraffePlayerClickListener giraffePlayerClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config == null || TextUtils.isEmpty(config.url)) {
            ...
            player.setGiraffePlayerClickListener(giraffePlayerClickListener);
    ...
    protected void onDestroy() {
        super.onDestroy();
        giraffePlayerClickListener = null;
        if (player != null) {
            player.onDestroy();
        }
    }
