...
/**
 * Created by parangat on 15/11/17.
 */
public class ScreamxoPlayer {
    /**
    ...
    private ScreamxoPlayerClickListener screamxoPlayerClickListener;
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.app_video_fullscreen) {
                ...
                if (!fullScreenOnly && !portrait) {
                    ...
                    if (activity instanceof ScreamxoPlayerActivity) {
                        activity.finish();
                    } else {
                        if (screamxoPlayerClickListener != null) {
                            screamxoPlayerClickListener.onBackArrowClicked();
                        }
                    }
                }
            } else if (v.getId() == R.id.img_share) {
                if (screamxoPlayerClickListener != null) {
                    screamxoPlayerClickListener.onShareButtonClicked();
                }
            }
        }
    };
    ...
    public ScreamxoPlayer(final Activity activity) {
        try {
            IjkMediaPlayer.loadLibrariesOnce(null);
            IjkMediaPlayer.native_profileBegin("libijkplayer.so");
            playerSupport = true;
        } catch (Throwable e) {
            Log.e("ScreamxoPlayer", "loadLibraries error", e);
        }
...
//                        Toaster.show("download rate:" + extra);
    ...
    /**
     * using constants in ScreamxoPlayer,eg: ScreamxoPlayer.SCALETYPE_FITPARENT
     *
     * @param scaleType
     */
...
//            }
     ...
     */
    public ScreamxoPlayer seekTo(int msec, boolean showControlPanle) {
...
//    public ScreamxoPlayer forward(float percent) {
...
//    }
    ...
    public ScreamxoPlayer playInFullScreen(boolean fullScreen) {
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public ScreamxoPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public ScreamxoPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public ScreamxoPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public ScreamxoPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener) {
     ...
     * @return
     */
    public ScreamxoPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public ScreamxoPlayer toggleAspectRatio() {
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public ScreamxoPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener) {
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }

    public void setScreamxoPlayerClickListener(ScreamxoPlayerClickListener screamxoPlayerClickListener) {
        this.screamxoPlayerClickListener = screamxoPlayerClickListener;
    }

    public interface ScreamxoPlayerClickListener {
