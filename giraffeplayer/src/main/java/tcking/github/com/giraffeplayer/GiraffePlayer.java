...
public class GiraffePlayer {
    /**
     * fitParent:scale the video uniformly (maintain the video's aspect ratio) so that both dimensions (width and height) of the video will be
     * equal to or **less** than the corresponding dimension of the view. like ImageView's `CENTER_INSIDE`.等比缩放,画面填满view。
     */
    public static final String SCALETYPE_FITPARENT = "fitParent";
    /**
     * fillParent:scale the video uniformly (maintain the video's aspect ratio) so that both dimensions (width and height) of the video will be
     * equal to or **larger** than the corresponding dimension of the view .like ImageView's `CENTER_CROP`.等比缩放,直到画面宽高都等于或小于view的宽高。
     */
    public static final String SCALETYPE_FILLPARENT = "fillParent";
    /**
     * wrapContent:center the video in the view,if the video is less than view perform no scaling,if video is larger than view then scale the video
     * uniformly so that both dimensions (width and height) of the video will be equal to or **less** than the corresponding dimension of the view.
    ...
    /**
     * 16:9:scale x and y with aspect ratio 16:9 until both dimensions (width and height) of the video will be equal to or **less** than the
     * corresponding dimension of the view.不剪裁,非等比例拉伸画面到16:9,并完全显示在View中。
     */
    public static final String SCALETYPE_16_9 = "16:9";
    /**
     * 4:3:scale x and y with aspect ratio 4:3 until both dimensions (width and height) of the video will be equal to or **less** than the
     * corresponding dimension of the view.不剪裁,非等比例拉伸画面到4:3,并完全显示在View中。
     */
    public static final String SCALETYPE_4_3 = "4:3";
    private static final String TAG = "GiraffePlayer";
    ...
    private GiraffePlayerClickListener giraffePlayerClickListener;
    ...
    private final View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.app_video_fullscreen) {
                if (giraffePlayerClickListener != null) {
                    giraffePlayerClickListener.onFullScreenBtnClicked();
                }
//                toggleFullScreen();
                ...
                if (!fullScreenOnly && !portrait) {
                    ...
                    if (activity instanceof GiraffePlayerActivity) {
                        activity.finish();
                    } else {
                        if (giraffePlayerClickListener != null) {
                            giraffePlayerClickListener.onBackArrowClicked();
                        }
                    }
                }
            } else if (v.getId() == R.id.img_share) {
                Log.d(TAG, "onClick giraffePlayerClickListener == null: " + (giraffePlayerClickListener == null));
                if (giraffePlayerClickListener != null) {
                    giraffePlayerClickListener.onShareButtonClicked();
                }
            }
        }
    };
...
//                        Toaster.show("download rate:" + extra);
        ...
        $.id(R.id.img_share).clicked(onClickListener);
    ...
    public void setGiraffePlayerClickListener(GiraffePlayerClickListener giraffePlayerClickListener) {
        this.giraffePlayerClickListener = giraffePlayerClickListener;
    }
...
//        Log.d(TAG, "onBackPressed fullScreenOnly: " + fullScreenOnly);
//        Log.d(TAG, "onBackPressed getScreenOrientation: " + getScreenOrientation());
...
//        updateFullScreenButton();
    ...
    public interface GiraffePlayerClickListener {
