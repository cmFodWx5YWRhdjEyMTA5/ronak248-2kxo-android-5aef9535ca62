...
public class TopUpActivity extends AppCompatActivity {
        ...
        try {
            ...
            floatingButton.setStateChangeListener(new FloatingMenuStateChangeListener() {
                ...
                public void onMenuOpened(FloatingMenuButton floatingMenuButton) {
                    ...
                    Utils.hideKeyboard(TopUpActivity.this);
            ...
            sbChat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    floatingButton.closeMenu();
                    Intent gotoNext = new Intent(TopUpActivity.this, UploadDataActivity.class);
    ...
    public void funAddMoney(View view) {
        if (!edAmount.getText().toString().equalsIgnoreCase("")) {
            Intent i = new Intent(TopUpActivity.this, NewConfigurePaymentActivity.class);
            i.putExtra("screen", TopUpActivity.class.getSimpleName());
            i.putExtra("amount", edAmount.getText().toString());
            startActivity(i);
            finish();
        } else {
            DialogBox.showDialog(this, getString(R.string.app_name), getString(R.string.msg_enter_amount), DialogBox.DIALOG_FAILURE, null);
        }
    }
}
